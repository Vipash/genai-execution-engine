...
class RecoverySupervisor:
    ...
    async def _triage_orphaned_message(self, redis: Redis, msg_id: str, fields: dict[str, str]) -> None:
        ...
        if delivery_count > settings.JOB_MAX_RETRIES:
            ...
            logger.info("supervisor.job_reclaimed_for_retry", job_id=job_id_str, msg_id=msg_id)